...
module.exports = function buildClient (baseUrl) {
	...
	var client = new ApiClient({
      ...
      updateLead: 'post /private/api/v2/json/leads/set',
...
function prepareUpdateLead (params, requestBody, opts) {
	requestBody = { request: { leads: { update: [params] } } };
	return [params, requestBody, opts];
}

function parseUpdateLead (res) {
	assert(res.data.response.leads.update.length && res.status === 200, 'Lead is not added due to some error');
	return res.data.response.leads.update[0];
}
